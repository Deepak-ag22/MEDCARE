...
export default function CardComp(val:any) {
  ...
  return (
        <div key={e.id} className={styles.card}>
          ...
          <h2 className={styles.name}>{e.name}, {e.degree}</h2>
          <div className={styles.infoContainer}>
            <Image src={"./Stethoscope.svg"} width={20} height={20} alt="Stethoscope" />
            <p className={styles.experience}>{e.specialty}</p>
            <Image src={"./Hourglass.svg"} width={20} height={20} alt="Hourglass" />
