  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.contacts}>
        ...
        <div className={styles.card}>
          <h2>Ambulance</h2>
          <p>Dial: <strong>981</strong> (vehicle support)</p>
        </div>
        <div className={styles.card}>
          <h2>Blood Bank</h2>
          <p>Dial: <strong>1-800-222-1221</strong></p>
        </div>
        <div className={styles.card}>
          <h2>Explore surroundings</h2>
          <p>Find the nearest hospital at <a href="https://www.hospitalfinder.com" className={styles.link}>Hospital Locator</a></p>
        </div>
      </section>
    </div>
  );
